      ...
      <b-row>
        <b-col>
          <b-form ref="form" inline novalidate :validated="validated">
            <b-form-input class="mx-auto" placeholder="Your friend's email" required v-model="id"></b-form-input>
            <b-button variant="primary" class="mx-auto" @click="sendEmail()">Send Invite</b-button>
          </b-form>
        </b-col>
      </b-row>
      <b-row>&nbsp;</b-row>
